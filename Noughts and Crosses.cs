...
namespace NoughtAndCross
{
    public partial class Form1 : Form
    {
        ...
        // Hello! All the pixel art in this program is my own and i would consider the special 
        ...
        // Noughts will always go first as player one, therefore if P1sGo = true, it is noughts go - this is useful for understanding the later program
        bool P1sGo = true;
